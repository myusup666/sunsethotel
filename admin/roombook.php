                ...
                <div class="row">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-footer">
							...
							<input type="submit" name="co" value="Konfirmasi" class="btn btn-success">
...
<?php
						...
						{	
							...
							if($st=="Konfirmasi")
							{
								...
								if($f1=="NO" )
								{
									echo "<script type='text/javascript'> alert('Sorry! Not Available Kamar Mewah ')</script>";
								}
								else if($f2 =="NO")
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Medium Size')</script>";
										
									}
									else if ($f3 == "NO")
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Single Kamar')</script>";
									}
										else if($f4=="NO")
										{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Kamar Favorit')</script>";
										}
										
										else if( mysqli_query($con,$urb))
											{	
												//echo "<script type='text/javascript'> alert('Guest Room booking is Konfirmasi')</script>";
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														if($troom=="Kamar Mewah")
														{
															$type_of_room = 320;
														
														}
														else if($troom=="Kamar Favorit")
														{
															$type_of_room = 220;
														}
														else if($troom=="Medium Size")
														{
															$type_of_room = 180;
														}
														else if($troom=="Single Kamar")
														{
															$type_of_room = 150;
														}
														...
														{	$notfree="NotFree";
															...
															{
															echo "<script type='text/javascript'> alert('Booking Konfirmasi')</script>";
