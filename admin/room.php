						...
						<form name="form" method="post">
                            <div class="form-group">
                                            ...
                                            <select name="troom"  class="form-control" required>
                                                ...
                                                <option value="Kamar Mewah">Kamar Mewah</option>
                                                <option value="Kamar Favorit">Kamar Favorit</option>
												<option value="MediumSize">MediumSize</option>
												<option value="Single Kamar">Single Kamar</option>
                                            </select>
                              </div>
