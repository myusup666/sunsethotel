        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="messages.php"><i class="fa fa-desktop"></i>Kabar Baru</a>
                    </li>
					<li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i>Pemesan Kamar</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Status <small>Pemesan Kamar</small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                    ...
                    <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 Pemesan Kamar Baru  <span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                      ...
                      <!-- End  Basic Table  --> 
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Pesanan Kamar  <span class="badge"><?php echo $r ; ?></span>
											</button>
                                ...
                                <div class="panel panel-danger">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Pengunjung  <span class="badge"><?php echo $f ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                            ...
                            <div class="table-responsive">
								...
								<a href="messages.php" class="btn btn-primary">Lainnya ACC</a>
                            </div>
                        </div>
                    </div>
                                        </div>
                                ...
                                <div class='modal-dialog'>
                                    <div class='modal-content'>
                                        <div class='modal-header'>
                                            ...
                                            <h4 class='modal-title' id='myModalLabel'>ganti nama user dan Password</h4>
                                        </div>
										<form method='post>
